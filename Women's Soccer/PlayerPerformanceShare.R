    ...
    sidebarLayout(
        ...
        mainPanel(
           h4("This dashboard showcases Player Performance for a Women's Soccer Team. The data is scaled to show individual 
              player performance (Performance_Scaled), performance compared to their teammates for the day (Day_Scaled), and a 
              rolling average. The summary statistics below the graph will update via the date range selection on the sidebar.", 
              align = "center"),
